...
public class ResourceManager {
	...
	public void loadCreatureSprites() {
		...
		images[0] = new Image[] { loadImage("Wolf1.png"),
				loadImage("Wolf2.png"), loadImage("Wolf3.png"),
				loadImage("Wolf4.png"), loadImage("Wolf5.png"),
				loadImage("Wolf6.png"), loadImage("Wolf7.png"),
				loadImage("fly1.png"), loadImage("fly2.png"),
				loadImage("fly3.png"), loadImage("players1.png"),
				loadImage("players2.png"),loadImage("players3.png"), };
		...
		for (int i = 0; i < 4; i++) {
			playerAnim[i] = createPlayerAnim(images[i][0], images[i][1],
					...
					images[i][6]);
			flyAnim[i] = createFlyAnim(images[i][7], images[i][8], images[i][9]);
			grubAnim[i] = createGrubAnim(images[i][10], images[i][11],images[i][12]);
		}
